 ...
 * opts.callback    点击滑动时的回调函数(和菜单数量`一致)
 * ===================================================
 **/
;
    ...
    Tab.prototype = {
        ...
        _initClass: function() {
            ...
            for (var i = 0; i < this.length; i++) {
                ...
                utils.removeClass(this.menus[i], this.currentClassName);
                utils.removeClass(this.contents[i], this.currentClassName);
            }
            utils.addClass(this.menus[this.index], this.currentClassName);
            utils.addClass(this.contents[this.index], this.currentClassName);
        },
        ...
        _replace: function() {
            utils.addClass(this.menus[this.index], this.currentClassName);
            utils.addClass(this.contents[this.index], this.currentClassName);
            utils.removeClass(this.menus[this.oldIndex], this.currentClassName);
            utils.removeClass(this.contents[this.oldIndex], this.currentClassName);
